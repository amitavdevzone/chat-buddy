...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\AiBot\AiBotInterface' => \App\Services\AiBot\LlamaBot::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/amitavroy/code/tutorials/chat-buddy/public/storage' => 'string',
            ...
            'services.llama.base_url' => 'string',
            'services.llama.summary_model' => 'string',
            ...
            'prism.providers.openai.organization' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/amitavroy/code/tutorials/chat-buddy/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.ai_provider','services.llama.base_url','services.llama.summary_model',
...
'cors.supports_credentials','prism.prism_server.middleware','prism.prism_server.enabled','prism.providers.openai.url','prism.providers.openai.api_key',
'prism.providers.openai.organization','prism.providers.openai.project','prism.providers.anthropic.api_key','prism.providers.anthropic.version','prism.providers.anthropic.default_thinking_budget',
...
'prism.providers.deepseek.api_key','prism.providers.deepseek.url','prism.providers.voyageai.api_key','prism.providers.voyageai.url','ide-helper.filename',
...
'conversation.index','message.store','message.response','providers.index','providers.create',
'providers.store','providers.show','model.fetch','profile.edit',
...
'verification.send','password.confirm','logout','chat',
'chat.conversation','storage.local',);
...
'AI_SERVICE','OPENAI_API_KEY','OPENAI_ORGANIZATION','OPENAI_REQUEST_TIMEOUT','LLAMA_BASE_URL',
'LLAMA_SUMMARY_MODEL',);
